        ...
        <div data-thq="thq-navbar-nav" className="navbar3-desktop-menu">
          <nav className="navbar3-links1">
            <a href={props.link1Url} className="thq-link thq-body-small">
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar3-text4">Home</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar3-text2">Tours</span>
                </Fragment>
              )}
            </a>
            <a href={props.link3Url} className="thq-link thq-body-small">
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar3-text5">Accommodations</span>
                </Fragment>
              )}
            </a>
            <a href={props.link4Url} className="thq-link thq-body-small">
              {props.link4 ?? (
                <Fragment>
                  <span className="navbar3-text3">Activities</span>
                </Fragment>
              )}
            </a>
...
Navbar3.defaultProps = {
  ...
  logoAlt: 'Andaman Islands Tours',
  link5Url: 'https://www.teleporthq.io',
  link1Url: 'https://www.teleporthq.io',
  link4: undefined,
  link4Url: 'https://www.teleporthq.io',
  link1: undefined,
  logoSrc: '3feee234-7b88-47dd-afa4-252def565f2d',
  link3: undefined,
}
