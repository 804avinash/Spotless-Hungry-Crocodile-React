        ...
        <div className="footer-content">
          <div className="footer-links">
            <div className="footer-column1">
              <strong className="footer-column1-title thq-body-large">
                {props.column1Title}
              </strong>
...
Footer.defaultProps = {
  ...
  content3: 'Designed with ❤️ by Oceanic Designs',
  column2Title: 'Contact Us',
  column1Title: 'Explore Andaman Islands',
