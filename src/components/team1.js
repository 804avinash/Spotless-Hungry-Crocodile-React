      ...
      <div className="team1-max-width thq-section-max-width">
        <div className="team1-section-title">
          <span className="thq-body-small team1-text10">
            {props.content1 ?? (
              <Fragment>
                <span className="team1-text46">Join Our Team Today!</span>
              </Fragment>
            )}
          </span>
          <div className="team1-content10">
            <h2 className="thq-heading-2 team1-text11">
              {props.heading1 ?? (
                <Fragment>
                  <span className="team1-text57">Meet Our Team</span>
                </Fragment>
              )}
            </h2>
                  ...
                  <div className="team1-content13">
                    <div className="team1-title1">
                      <span className="team1-text13 thq-body-small">
                        {props.member1 ?? (
                          <Fragment>
                            <span className="team1-text63">John Smith</span>
                          </Fragment>
                        )}
                      </span>
                      ...
                      {props.member1Content ?? (
                        <Fragment>
                          <span className="team1-text56">
                            John is the visionary behind our travel agency, with
                            a passion for creating unforgettable experiences for
                            our clients.
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="team1-content14">
                    <div className="team1-title2">
                      <span className="team1-text16 thq-body-small">
                        {props.member2 ?? (
                          <Fragment>
                            <span className="team1-text48">Emily Davis</span>
                          </Fragment>
                        )}
                      </span>
                      ...
                      {props.member2Content ?? (
                        <Fragment>
                          <span className="team1-text69">
                            Emily ensures that every tour runs smoothly and
                            efficiently, providing exceptional service to our
                            customers.
                          </span>
                        </Fragment>
                      )}
                      ...
                      {props.member3Content ?? (
                        <Fragment>
                          <span className="team1-text67">
                            Michael leads our tours with expertise and
                            enthusiasm, sharing his knowledge of the Andaman
                            Islands with our guests.
                          </span>
                        </Fragment>
                      )}
                    </span>
                  ...
                  <div className="team1-content16">
                    <div className="team1-title4">
                      <span className="team1-text22 thq-body-small">
                        {props.member4 ?? (
                          <Fragment>
                            <span className="team1-text65">Sarah Lee</span>
                          </Fragment>
                        )}
                      </span>
                      ...
                      {props.member4Content ?? (
                        <Fragment>
                          <span className="team1-text41">
                            Sarah takes care of our clients&apos; needs,
                            ensuring they have a seamless booking experience and
                  ...
                  <div className="team1-content17">
                    <div className="team1-title5">
                      ...
                      <span className="team1-text26 thq-body-small">
                        {props.member5Job ?? (
                          <Fragment>
                            <span className="team1-text52">Job title</span>
                          </Fragment>
                        )}
                      </span>
                    </div>
                  ...
                  <div className="team1-content19">
                    <div className="team1-title7">
                      ...
                      <span className="team1-text32 thq-body-small">
                        {props.member7Job ?? (
                          <Fragment>
                            <span className="team1-text44">Job title</span>
                          </Fragment>
                        )}
                      </span>
                    </div>
          ...
          <div className="team1-content21">
            ...
            <button className="team1-button thq-button-filled">
              <span className="thq-body-small">
                {props.actionContent ?? (
                  <Fragment>
                    <span className="team1-text68">Open positions</span>
                  </Fragment>
                )}
              </span>
            </button>
...
Team1.defaultProps = {
  ...
  member4Src:
    'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjMyMTI1M3w&ixlib=rb-4.1.0&q=80&w=1080',
  member1Job: undefined,
  member8Alt: 'Member Alt',
  member5Src:
    'https://images.unsplash.com/photo-1534865007446-5214dca11db4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjMyMTI1MXw&ixlib=rb-4.1.0&q=80&w=1080',
  member7: undefined,
  ...
  heading1: undefined,
  member2Src:
    'https://images.unsplash.com/photo-1601455763557-db1bea8a9a5a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjMyMTI1OHw&ixlib=rb-4.1.0&q=80&w=1080',
  member3Src:
    'https://images.unsplash.com/photo-1489980557514-251d61e3eeb6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjMyMTI1M3w&ixlib=rb-4.1.0&q=80&w=1080',
  member6Src:
    'https://images.unsplash.com/photo-1565250923240-0744cafd8ad6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjMyMTI1M3w&ixlib=rb-4.1.0&q=80&w=1080',
  content2: undefined,
  member1Src:
    'https://images.unsplash.com/photo-1499482125586-91609c0b5fd4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjMyMTI1OXw&ixlib=rb-4.1.0&q=80&w=1080',
  member3: undefined,
  member7Src:
    'https://images.unsplash.com/photo-1560787313-5dff3307e257?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjMyMTI1Nnw&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  member1: undefined,
  member8Src:
    'https://images.unsplash.com/photo-1632377082370-6608a1e37c64?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjMyMTI1MHw&ixlib=rb-4.1.0&q=80&w=1080',
  member8: undefined,
  member4: undefined,
  member2Alt: 'Image of Emily Davis',
